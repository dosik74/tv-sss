...
class KodikParser:
    ...
    def get_embed_link(self, id: str, id_type: str, https: bool = True) -> str:
        ...
        if id_type == "shikimori":
            ...
            if 'tt' in id:
                serv = f"https://kodik-api.com/get-player?title=Player&hasPlayer=false&url=https%3A%2F%2Fkodikdb.com%2Ffind-player%3FimdbID%3D{id}&token={self.TOKEN}&imdbID={id}"
            else:
                serv = f"https://kodik-api.com/get-player?title=Player&hasPlayer=false&url=https%3A%2F%2Fkodikdb.com%2Ffind-player%3FimdbID%3Dtt{id}&token={self.TOKEN}&imdbID=tt{id}"
        elif id_type == "mdl":
            serv = f"https://kodik-api.com/get-player?title=Player&hasPlayer=false&url=https%3A%2F%2Fkodikdb.com%2Ffind-player%3FmdlID%3D{id}&token={self.TOKEN}&mdlID={id}"
        elif id_type == "kodik":
            serv = f"https://kodik-api.com/get-player?title=Player&hasPlayer=false&url=https%3A%2F%2Fkodikdb.com%2Ffind-player%3FID%3D{id}&token={self.TOKEN}&ID={id}"
        elif id_type == "worldart_animation":
            serv = f"https://kodik-api.com/get-player?title=Player&hasPlayer=false&url=https%3A%2F%2Fkodikdb.com%2Ffind-player%3Fworldart_animation_id%3D{id}&token={self.TOKEN}&worldart_animation_id={id}"
        elif id_type == "worldart_cinema":
            serv = f"https://kodik-api.com/get-player?title=Player&hasPlayer=false&url=https%3A%2F%2Fkodikdb.com%2Ffind-player%3Fworldart_cinema_id%3D{id}&token={self.TOKEN}&worldart_cinema_id={id}"
        else:
